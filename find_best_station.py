...
def find_best_station(USER_LOCATION, TOMTOM_API_KEY, INCLUDE_NAVIGATION ,RETURN_FULL_JSON):
    available_stations = []
    iteration = 0
...
if __name__ == "__main__":
    ...
    top_station = find_best_station(USER_LOCATION, TOMTOM_API_KEY, INCLUDE_NAVIGATION, RETURN_FULL_JSON)
    if top_station:
